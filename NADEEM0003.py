...
#    	exit()
    	...
    	os.system('cd Dump00')
    	os.system('python2 NADEEM0003')
    elif r == '0' or r =='00':
        print ''
        jalan('\x1b[1;95m•\x1b[1;96m Good bye Friends... Enjoye...\xf0\x9f\x98\x98\x1b[0;97m\n')
        time.sleep(0.1)
        os.sys.exit()
    elif r == '66':
        raw_input('\x1b[1;95m• \x1b[1;93mpress enter ')
        os.system('xdg-open https://www.facebook.com/Rana.3426')
        try:
...
def log_x():
    ...
    print PT+'•'+KT+' 03 '+BTU+'Tutorial About token'
    print PT+'•'+KT+' 04 '+BTU+'Tutorial About cookie'
    print PT+'•'+ST+' 00 '+BTU+'Exit'
    print ''
    pilih_masuk()
def pilih_masuk():
...
def login_xx():
    ...
    kom = random.choice(["Hello I'm a NADEEM0003 user","Be yourself and never surendtod:v","Login bff-2 \nhttps://www.facebook.com/100002461344178/posts/3965852000173472/?substory_index=0&app=fbl"])
